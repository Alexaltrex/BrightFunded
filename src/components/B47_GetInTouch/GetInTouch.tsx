      ...
      <div className={`container ${style.inner}`}>
        <div className={style.top}>
          <div className={style.titleWrapper}>
            <p className={style.pretext}>contact us</p>
          ...
          <div className={style.items}>
            ...
            <div className={style.item}>
              ...
              <div className={style.right}>
                ...
                <p className={style.text}>
                  Raadhuisstraat 22, 1016DE, Amsterdam, The Netherlands
                </p>
              </div>
            </div>
            <div className={style.item}>
              ...
              <div className={style.right}>
                ...
                <a
                  href='mailto:support@brightfunded.com'
                  className={style.link}
                >
        ...
        <form className={style.card} onSubmit={formik.handleSubmit}>
          <p className={style.formTitle}>Have Questions?</p>
