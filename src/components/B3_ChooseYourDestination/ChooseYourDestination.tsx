...
export const ChooseYourDestination = observer(() => {
  ...
  return (
    <div className={style.chooseYourDestination} id='trading-objectives'>
      <div className={style.top} />

      <div className={`container ${style.content}`}>
        <div className={style.inner}>
          <div className={style.titleWrapper}>
            <p className={style.pretext}>choose your destination</p>
          ...
          <div className={style.rest}>
            <div className={style.leftBlock}>
              ...
              />
              <TableCustom currency={currency} balance={Number(balance) || 0} />
            </div>

            <div className={style.rightBlock}>
              <div className={style.slider}>
                <PlanetSlider
                  setCardSwiper={(s) => setCardSwiper(s)}
