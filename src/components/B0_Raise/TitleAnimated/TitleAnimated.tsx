...
const text =
  'Clients who successfully complete the BrightFunded Evaluation Process are granted the opportunity to trade for BrightFunded B.V. To avoid any misunderstandings, BrightFunded offers demo accounts with virtual capital to clients at all phases of the partnership.';
  ...
  return (
    <>
      <div className={style.wrapperMobile}>
        <TooltipCustomMobile
          title={
            <div className={style.tooltipContent} ref={targetRef}>
              <p>{text}</p>
            </div>
          }
          open={open}
        ...
        >
          <div
            ...
            ref={outsideRef}
          >
            <p className={clsx('anim1')}>
              Our <span>Capital</span>
            </p>
