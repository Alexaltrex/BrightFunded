    ...
    <div className={style.openPositions}>
      <div className={`container ${style.inner}`}>
        <div className={style.top}>
          <p className={style.title}>Open Positions</p>
          <div className={style.right}>
            <p className={style.text}>
              At <span>BrightFunded</span>, your potential is waiting to be
              discovered.
            </p>
            <p className={style.description}>
              Check out our current job openings and step into an environment
              where you are encouraged to push boundaries and make an impact.
            </p>
          </div>
        </div>
        ...
        <div className={style.cards}>
          <div className={style.inner}>
            {[...positions]
              .filter((position) =>
                category === 0 ? true : position.category === category
              )
              .map((position, key) => (
