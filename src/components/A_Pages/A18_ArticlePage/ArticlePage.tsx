...
const ArticlePage = () => {
  ...
  const similarCards = similar.map(
    (id) => news.find((el) => el.id === id) as ICard
  );

  return (
    <div className={style.articlePage} id='article-top'>
      <div className={style.card}>
        <div className={style.top}>
          <div className={`container ${style.inner}`}>
            ...
            <div className={style.content}>{fullText}</div>
          </div>
        </div>
