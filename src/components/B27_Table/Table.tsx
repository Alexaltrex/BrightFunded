        ...
        <div className={style.table}>
            <div className={style.inner}>
                    ...
                    <div className={style.tableWrapper}>
                        ...
                        <div className={style.swiperWrapper}>
                            ...
                            >
                                {
                                    [0,1,2]
                                        .map(index => [Object.keys(data)[index + 1], ...Object.values(data)[index + 1]])
                                        .map((value, key) => (
                                            <SwiperSlide key={key}
                    ...
                    <div className={style.body}>
                        {
                            Array
                                .from({length: 7}, (_, k) => k)
                                // @ts-ignore
                                .map(index => Object.keys(data).map(value => data[value][index]))
                                .map((row, key) => (
                                    <div className={style.row} key={key}>
                                        {
                                            row.map((v, j) => (
                ...
                <p className={style.table_text}>
                    The table shows the scaling process based on the maximum allocation of $400,000.
                </p>
