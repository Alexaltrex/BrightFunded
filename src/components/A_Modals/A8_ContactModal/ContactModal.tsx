        ...
        >
            <div className={style.card}>
                ...
                <p className={style.description}>
                    Thanks for reaching out! Your message has been received and we'll get back to you as soon as
                    possible. In the meantime, you might find immediate answers in our vibrant Discord community. Join
