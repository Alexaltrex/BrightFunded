        ...
        >
            <div className={style.card}>
                ...
                <p className={style.description}>
                    <p>
                        Brilliant decision! Your application for the BrightFunded Affiliate Program has been
                        successfully submitted and is now under review.
                    </p>
                    <br/>
                    <p>
                        Keep an eye on your inbox for a confirmation email from us, which will include further details
                        about your affiliate partner account and your exclusive referral link.
                    </p>
                    <br/>
                    <p>
                        Together, we're set to revolutionize the world of trading!
                    </p>
                </p>
